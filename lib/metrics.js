...
const pageDurationGauge = new client.Gauge({
  name: 'ril_page_duration_gauge',
  help: 'ril_page_duration_gauge Page durations for all service forms',
  labelNames: ['page'],
});

const applicationFormDurationGauge = new client.Gauge({
  name: 'ril_application_form_duration_gauge',
  help: 'ril_application_form_duration_gauge Application Form submission duration',
});

const acceptanceFormDurationGauge = new client.Gauge({
  name: 'ril_acceptance_form_duration_gauge',
  help: 'ril_acceptance_form_duration_gauge Application Form submission duration',
  labelNames: ['page'],
});
...
registry.registerMetric(pageDurationGauge);
registry.registerMetric(applicationFormDurationGauge);
registry.registerMetric(acceptanceFormDurationGauge);
